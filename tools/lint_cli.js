...
for (const id in d.lists) d.lists[id].lint.entries = d.lists[id].lint.entries.map(o => ({ id: o.entry.id, unit: o.entry.unit, pts: o.pts, flags: o.flags, enh: o.enh && o.enh.id }));
